...
export default function Overlay() {
  ...
  return (
    <div
      ...
      className="flex flex-col w-[350px] min-w-[350px] bg-white text-black font-sans overflow-hidden border-4 border-black box-border shadow-[8px_8px_0_0_rgba(0,0,0,1)]"
    >
      <header className="p-4 bg-white border-b-4 border-black flex justify-between items-center shrink-0 m-0">
        <div className="flex items-center gap-2">
          <img src={chrome.runtime.getURL('logo.png')} alt="Logo" className="w-6 h-6 object-contain" />
          <h1 className="m-0 text-base font-bold text-black uppercase tracking-wider">Subscriptos</h1>
        </div>
        <button onClick={dismiss} className="text-black hover:bg-gray-100 hover:text-brand-magenta flex items-center justify-center w-8 h-8 rounded-none border-0 bg-transparent cursor-pointer transition-colors p-0 m-0 leading-none">
          <X className="w-5 h-5 pointer-events-none" strokeWidth={2.5} />
        </button>
      </header>
