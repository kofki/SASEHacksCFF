...
export default function Popup() {
  ...
  return (
    <div className="flex flex-col h-[500px] w-[350px] min-w-[350px] min-h-[500px] bg-white text-black font-sans overflow-hidden border-4 border-black">
      <header className="p-4 bg-white border-b-4 border-black text-center">
        <h1 className="m-0 text-lg font-bold text-black uppercase tracking-wider">SASEHacks CFF</h1>
      </header>

      <nav className="flex border-b-4 border-black bg-gray-100">
        <button
      ...
      <main className="p-5 flex-1 overflow-y-auto bg-white">
        {tab === 'scan' && (
          <div className="flex flex-col h-full">
            ...
            <textarea
              className="w-full p-3 mb-5 bg-white border-4 border-black rounded-none shadow-[4px_4px_0_0_#000] text-black text-sm focus:outline-none focus:translate-x-0.5 focus:translate-y-0.5 focus:shadow-[2px_2px_0_0_#000] transition-all resize-none"
              placeholder="Paste contract text here..."
              rows={4}
            />
            <button className="w-full p-3 bg-brand-magenta text-white font-bold rounded-none border-4 border-black shadow-[6px_6px_0_0_#000] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[4px_4px_0_0_#000] transition-all duration-200 cursor-pointer mb-5 text-lg">
              Analyze Contract
            </button>
            <div className="bg-[#f4f4f5] p-4 rounded-none border-4 border-black shadow-[4px_4px_0_0_#000] text-sm mt-auto">
        ...
        {tab === 'cards' && (
          <div className="flex flex-col h-full">
            ...
            <button className="w-full p-3 mt-auto bg-brand-cyan text-black font-bold rounded-none border-4 border-black shadow-[6px_6px_0_0_#000] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[4px_4px_0_0_#000] transition-all duration-200 cursor-pointer text-lg">
